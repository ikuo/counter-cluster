seed1: NODE_ID=seed1 java -Dconfig.resource=/seed1.conf -javaagent:aspectjweaver-1.8.6.jar -jar target/scala-2.11/counter-cluster-assembly-0.1-SNAPSHOT.jar|tee log/seed1.log
